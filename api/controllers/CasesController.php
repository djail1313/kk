...
class CasesController extends ActiveController
{
	public $modelClass = 'common\models\Cases';
    ...
    public function indexDataProvider() {
        ...
        $searchByAttr['CasesSearch'] = $search;
        $searchModel = new \common\models\CasesSearch();    
