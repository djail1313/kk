...
class ChronologyController extends ActiveController
{
	public $modelClass = 'common\models\Chronology';
    ...
    public function indexDataProvider() {
        ...
        $searchByAttr['ChronologySearch'] = $search;
        $searchModel = new \common\models\ChronologySearch();    
