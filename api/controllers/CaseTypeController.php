...
class CaseTypeController extends ActiveController
{
	public $modelClass = 'common\models\CaseType';
    ...
    public function indexDataProvider() {
        ...
        $searchByAttr['CaseTypeSearch'] = $search;
        $searchModel = new \common\models\CaseTypeSearch();    
